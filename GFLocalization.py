...
class GFLocalization(Localization,GaussianFilter):
    ...
    def Localize(self, xk_1, Pk_1):
        ...
        print(f"Localization step {self.k}: xk = {xk.shape}, Pk = {Pk.shape}, xk_bar = {xk_bar.shape}, Pk_bar = {Pk_bar.shape}, zk = {zk.shape}, Rk = {Rk.shape}, Hk = {Hk.shape}, Vk = {Vk.shape}")
    ...
    def Log(self, xsk, xk, Pk, xk_bar, zk):
        ...
        # self.log_z[0:zk.shape[0], self.k] = zk.T
        self.k += 1
